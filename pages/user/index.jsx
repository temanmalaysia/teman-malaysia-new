...
function User() {
  ...
  const addRecipient = () => {
    if (recipients.length >= MAX_RECIPIENTS) {
      setMessage({ type: 'error', text: `You can only add up to ${MAX_RECIPIENTS} care recipients.` });
      return;
    }
    setRecipients((prev) => ([
      ...prev,
  ...
  const saveRecipients = (e) => {
    ...
    try {
      ...
      setMessage({ type: 'success', text: 'Care recipients saved successfully.' });
    } catch {
      ...
      <main className="user-profile">
        ...
        <section className="user-profile__content">
          <div className="container">
            {/* Message Alert */}
            {message.text && (
              <div className={`user-profile__alert ${message.type === 'success' ? 'user-profile__alert--success' : 'user-profile__alert--error'}`}>
            ...
            <div className="user-profile__grid">
              ...
              <div className="user-profile__card">
                ...
                <form className="user-profile__form" onSubmit={saveProfile} noValidate data-testid="profile-form">
                  <div className="user-profile__form-row">
                    <div className="user-profile__form-group">
                      <label htmlFor="fullName" className="user-profile__label">
                        Full Name <span className="user-profile__required">*</span>
                      </label>
                      <input
                        id="fullName"
                        name="fullName"
                    ...
                    <div className="user-profile__form-group">
                      <label htmlFor="icNumber" className="user-profile__label">IC Number</label>
                      <input
                        id="icNumber"
                        name="icNumber"
                        type="text"
                  ...
                  <div className="user-profile__form-row">
                    <div className="user-profile__form-group">
                      <label htmlFor="phoneNumber" className="user-profile__label">
                        Phone Number <span className="user-profile__required">*</span>
                      </label>
                      <input
                        id="phoneNumber"
                        name="phoneNumber"
                    ...
                    <div className="user-profile__form-group">
                      <label htmlFor="emailAddress" className="user-profile__label">
                        Email Address <span className="user-profile__required">*</span>
                      </label>
                      <input
                        id="emailAddress"
                        name="emailAddress"
                  ...
                  <div className="user-profile__form-row">
                    <div className="user-profile__form-group">
                      <label htmlFor="emergencyContact" className="user-profile__label">Emergency Contact</label>
                      <input
                        id="emergencyContact"
                  ...
                  {showSaveProfileButton && (
                    <div className="user-profile__form-actions">
                      <button type="submit" className="user-profile__btn user-profile__btn--primary" data-testid="save-profile-btn">
                        <FaCheck />
              ...
              <div className="user-profile__card">
                <div className="user-profile__card-header">
                  ...
                  <div>
                    <h2 className="user-profile__card-title">Care Recipients</h2>
                    <p className="user-profile__card-subtitle">People you are booking services for</p>
                  </div>
                </div>

                <div className="user-profile__recipients-intro">
                  <div className="user-profile__recipients-intro-content">
                    <p>Add the details of your loved ones to make booking faster and easier.</p>
                ...
                {recipients.length > 0 && (
                  <form className="user-profile__form" onSubmit={saveRecipients} data-testid="recipients-form">
                    <div className="user-profile__recipients-list">
                      {recipients.map((r, index) => (
                        <div key={index} className="user-profile__recipient-card" data-testid={`recipient-${index}`}>
                          <div className="user-profile__recipient-header">
                            <span className="user-profile__recipient-number">Recipient {index + 1}</span>
                            <button 
                              type="button" 
                          ...
                          <div className="user-profile__form-row">
                            ...
                            <div className="user-profile__form-group">
                              ...
                              <input
                                ...
                                value={r.age}
                                onChange={(e) => updateRecipient(index, 'age', e.target.value)}
                                min="0"
                              />
                            </div>
                          </div>
                          ...
                          <div className="user-profile__form-row">
                            <div className="user-profile__form-group">
                              ...
                              <select
                                ...
                                value={r.gender}
                                onChange={(e) => updateRecipient(index, 'gender', e.target.value)}
                              >
                            ...
                            <div className="user-profile__form-group">
                              <label className="user-profile__label">Preferred Language</label>
                              <select
                                className="user-profile__select"
                                value={r.preferredLanguage}
                                onChange={(e) => updateRecipient(index, 'preferredLanguage', e.target.value)}
                              >
                          ...
                          <div className="user-profile__form-row">
                            <div className="user-profile__form-group">
                              <label className="user-profile__label">Weight (kg)</label>
                              <input
                                type="number"
                                className="user-profile__input"
                                placeholder="Weight in kg"
                                value={r.weight}
                                onChange={(e) => updateRecipient(index, 'weight', e.target.value)}
                                min="0"
                                step="0.1"
                              />
                            </div>
                            <div className="user-profile__form-group">
                              <label className="user-profile__label">Height (cm)</label>
                              <input
                                type="number"
                                className="user-profile__input"
                    ...
                    {isRecipientsDirty && (
                      <div className="user-profile__form-actions">
                        <button type="submit" className="user-profile__btn user-profile__btn--primary" data-testid="save-recipients-btn">
                          <FaCheck />
                ...
                {recipients.length === 0 && (
                  <div className="user-profile__empty-state">
                    ...
                    <span>Click the button above to add your first care recipient.</span>
                  </div>
                )}
              </div>
            </div>

...
export const healthPackages = [
  {
    ...
    price: 'RM35/hour',
    priceNote: '',
    description: 'Choose the number of hours for service, as needed. Minimum 2 hours booking',
  ...
  },
  {
    ...
    price: 'RM186',
    priceNote: '(RM31/hour)',
    description: 'Suitable for longer appointment sessions, or short appointments with extended activities (eg: meals, errands, etc.)',
    hasHoursSelection: false,
  },
];
...
export const healthAdditionalInfo = [
  '• Surcharge: RM37/hour for services on Public Holiday / Sundays / from last-minute bookings (<24 hours)',
...
export const dialysisPackages = [
  {
    ...
    price: 'RM35/hour',
    priceNote: '',
    description: 'Choose number of hours required for drop-off and pickup. Please allow travel time and pre- and post- treatment waiting time. Service does not include companionship',
    hasHoursSelection: true,
  },
  {
    ...
    description: '3 dialysis sessions at 2 hours service each. Service Inclusive of transportation, travel time and pre-post treatments waiting time. Service does not include companionship DURING treatment.',
    hasHoursSelection: false,
  },
];
...
export const dialysisAddonConfig = {
  ...
  price: '+RM30/hour',
  description: 'Dialysis sessions do take awhile. Request the Temanion to stay with you through it, so you are not alone. Price and hours are added-on to basic transport service rate. They may assist you with:',
